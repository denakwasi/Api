...
from pymongo import errors  # Import errors module correctly
...
app_ = Flask(__name__)
CORS(app_)  # Enable CORS for all routes
...
class MongoDBManager:
    def __init__(self):
        # Development credentials (REPLACE WITH ENVIRONMENT VARIABLES IN PRODUCTION)
...
@app_.route('/user/update/<user_id>', methods=['PUT'])
...
@app_.route('/user/<user_ID>', methods=['GET'])
...
@app_.route('/user/byid/<user_id>', methods=['GET'])
...
@app_.route('/user/password/<user_ID>', methods=['PUT'])
...
@app_.route('/user/<state>/<user_id>', methods=['PUT'])
...
@app_.route('/user/online-status/<user_id>', methods=['PUT'])
...
@app_.route('/verify-otp', methods=['POST'])
def verify_otp():
    try:
        data = request.get_json()
...
@app_.route('/user/otp/<user_ID>', methods=['PUT'])
...
@app_.route('/users/<user_id>', methods=['DELETE'])
...
@app_.route('/users/delete-many', methods=['POST'])
...
@app_.route('/courses', methods=['GET'])
def get_courses():
    try:
...
@app_.route('/course/<course_id>', methods=['PUT'])
...
@app_.route('/course/<course_id>', methods=['DELETE'])
...
@app_.route('/course/enroll', methods=['POST'])
def enroll_student():
    try:
        data = request.get_json()
...
@app_.route('/course', methods=['POST'])
def create_course():
    try:
        data = request.get_json()
        # Validate required fields
...
@app_.route('/user/register-courses', methods=['POST'])
...
@app_.route('/user/registered-courses/<user_id>', methods=['GET'])
...
@app_.route('/user/unregister-courses', methods=['POST'])
...
@app_.route('/courses/instructor/<instructor_id>', methods=['GET'])
...
@app_.route('/tasks/course/<course_id>', methods=['GET'])
...
@app_.route('/task/<task_id>', methods=['GET'])
...
@app_.route('/task/<task_id>', methods=['PUT'])
...
@app_.route('/task/<task_id>', methods=['DELETE'])
...
@app_.route('/task/<task_id>/file/<file_id>', methods=['GET'])
...
@app_.route('/task/submit/<task_id>', methods=['POST'])
...
@app_.route('/tasks/student/<student_id>', methods=['GET'])
...
@app_.route('/task/student/<task_id>/<student_id>', methods=['GET'])
...
@app_.route('/task/student/submit/<task_id>', methods=['POST'])
...
@app_.route('/task/grade/<task_id>/<student_id>', methods=['POST'])
...
@app_.route('/file/<file_id>', methods=['GET'])
...
@app_.route('/file/by-name/<filename>', methods=['GET'])
...
@app_.route('/task/<task_id>/submission/<student_id>/file/<file_id>', methods=['GET'])
...
@app_.route('/course/by-name/<course_name>', methods=['GET'])
...
@app_.route('/api/update-event', methods=['PUT'])
...
@app_.route('/api/update-event-permission', methods=['PUT'])
...
@app_.route('/events/date/<date>', methods=['GET'])
...
@app_.route('/events/user/<user_id>', methods=['GET'])
...
@app_.route('/all-events', methods=['GET'])
def get_all_events():
    try:
...
@app_.route('/event/<event_id>', methods=['DELETE'])
...
@app_.route('/api/delete-event', methods=['DELETE'])
...
@app_.route('/task/check-submission-permission/<task_id>', methods=['GET'])
...
if __name__ == "__main__":
    ...
    app_.run(host='0.0.0.0', port=port, debug=False, threaded=True)